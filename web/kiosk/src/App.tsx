...
import { PLAYER_ID, SUPABASE_URL, SUPABASE_ANON_KEY } from '@shared/config';
  ...
  const connectionCheckIntervalRef = useRef<number | null>(null);
    ...
    const performSearch = async (query: string) => {
      try {
        ...
        const resp = await fetch(`${SUPABASE_URL}/functions/v1/youtube-scraper`, {
          method: 'POST',
          headers: {
        ...
        // Handle new ApiResponse envelope { success: true, data: { videos, count } }
        // as well as old direct { videos } shape for backwards compat during rollout
