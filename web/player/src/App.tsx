...
function App() {
  ...
  return (
    <div className="relative w-screen h-screen bg-black">
      ...
      {/* Logo Overlay — image path comes from player_settings.branding.logo */}
      {settings?.branding?.logo && (
        <img
          src={settings.branding.logo}
          alt={settings.branding.name || 'Jukebox Logo'}
      ...
      {status?.state === 'idle' && !currentMedia && (
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black">
          <div className="text-center">
            <div className="text-6xl font-bold text-white mb-4">{settings?.branding?.name || 'Jukebox'}</div>
