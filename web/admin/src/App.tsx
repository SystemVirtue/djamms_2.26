...
import { PLAYER_ID } from '@shared/config';
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ width: 380, background: '#0e0e0e', border: '1px solid var(--border)', borderRadius: 20, padding: 36, position: 'relative' }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 24, fontWeight: 700, color: '#fff', letterSpacing: '-0.02em' }}>Admin Console</h1>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '13px 13px', height: 54, flexShrink: 0, borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        {expanded && <>
          <div style={{ overflow: 'hidden', flex: 1 }}>
            <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15, color: '#fff', letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>{brandingName || 'Admin'}</div>
